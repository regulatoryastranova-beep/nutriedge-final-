 ...
 const selectLang = (code) => {
  ...
  return (
    <div ref={menuRef} className="relative">
      ...
      {open && (
        <div className="absolute right-0 mt-2 w-64 bg-white rounded-md shadow-xl border border-gray-100 z-50 flex flex-col" data-testid="language-switcher-menu">
          <div className="relative p-2 border-b border-gray-100">
            ...
            <input
              ...
              className="w-full pl-8 pr-2 py-1.5 text-xs text-[#0a2a66] border border-gray-200 rounded focus:outline-none focus:border-[#0f3d91]"
            />
          </div>
