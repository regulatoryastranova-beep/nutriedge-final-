            ...
            {milestones.map((m, i) => {
              ...
              return (
                ...
                >
                  ...
                  <h4 className="font-display text-lg font-semibold text-[#0a2a66] mb-2">
                    {m.title}
                  </h4>
...
function Infrastructure() {
  ...
  return (
    <section
      id="infrastructure"
      ref={ref}
      className="reveal py-20 bg-[#f7f4ec]"
    >
      <div className="max-w-7xl mx-auto px-6">
        ...
        <div className="grid lg:grid-cols-2 gap-10 items-center mb-14">
          <div className="relative">
            ...
            <img
              ...
              alt="Factory"
              className="relative rounded-2xl shadow-2xl w-full h-[440px] object-cover"
            />
            ...
            <div className="absolute -bottom-6 -left-6 bg-white rounded-lg shadow-xl p-4">
              ...
              <p className="text-2xl font-bold ne-gradient-text-blue">
                15,000 Sq. Ft.
              </p>
            </div>
          </div>
          ...
          <div>
            <h3 className="font-display text-2xl md:text-3xl font-semibold text-[#0a2a66] mb-4">
              {infrastructure.headline}
            </h3>

            <p className="text-gray-700 leading-relaxed mb-6">
              A state-of-the-art A-grade campus in Kathwada GIDC, Ahmedabad,
              equipped with automated manufacturing lines, temperature-controlled
              zones and an accredited quality-control laboratory.
            </p>
            ...
            <ul className="grid grid-cols-1 sm:grid-cols-2 gap-3 mb-6">
              {infrastructure.facts.map((f) => (
                ...
                >
                  ...
                  <div>
                    <p className="font-bold text-[#0a2a66]">
                      {f.label}
                    </p>
        ...
        <div className="bg-white rounded-2xl shadow-lg p-8">
          <div className="text-center mb-8">
            ...
            <h3 className="font-display text-2xl md:text-3xl font-semibold ne-gradient-text-blue mt-2">
              Manufacturing Scale
            </h3>
          ...
          <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-3 gap-4">
            {infrastructure.capacity.map((c, i) => (
              ...
              >
                <p className="text-2xl md:text-3xl font-bold ne-gradient-text-blue mb-1">
                  {c.qty}
                </p>
...
export default function About() {
  ...
  useEffect(() => {
    document.title =
      'About NutriEdge Lifesciences | Pharmaceutical & Nutraceutical Company';
  }, []);

  /*
   * Handle About page hash navigation.
   *
   * /about
   *        → scroll to top
   *
   * /about#director
   *        → scroll to Director's Word
   *
   * /about#infrastructure
   *        → scroll to Infrastructure
   */
  useEffect(() => {
    const timer = setTimeout(() => {
      // If there is no hash, return to the top of the About page
      if (!location.hash) {
        window.scrollTo({
          top: 0,
          behavior: 'smooth',
  ...
  return (
    <main>
      <PageHero
        title="About Us"
        subtitle="Building a healthier tomorrow through science, integrity, and world-class nutraceutical manufacturing."
      />
          ...
          {[
            {
              Icon: Target,
              title: 'Our Mission',
              text: 'To empower brands worldwide with premium nutraceutical products that combine cutting-edge science with uncompromising quality.'
            },
            {
              Icon: Eye,
              title: 'Our Vision',
              text: 'To be the most trusted nutraceutical CDMO (Contract Development & Manufacturing Organization) partner globally, driving innovation for healthier lives across generations.'
            },
            {
              Icon: Sparkles,
              title: 'Our Values',
              text: 'Integrity, quality, transparency, and customer-first thinking guide every decision we make at NutriEdge Lifesciences.'
            }
          ].map(({ Icon, title, text }, i) => (
            <div
              key={title}
              className="group p-8 rounded-xl bg-[#f7f4ec] hover-lift reveal-item"
              style={{ animationDelay: `${i * 120}ms` }}
            >
              ...
              <h3 className="font-display text-2xl font-semibold text-[#0a2a66] mb-3">
                {title}
              </h3>
